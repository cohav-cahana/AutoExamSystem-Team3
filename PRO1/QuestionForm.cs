    ...
    public partial class QuestionForm : Form
    {
        ...
        private void dataGridView1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (dataGridView1.Columns[e.ColumnIndex].Name == "deleteButton")
            {
                ...
                cell.Style.BackColor = Color.FromArgb(220, 80, 80); 
        ...
        private async void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.Columns[e.ColumnIndex].Name == "deleteButton")
            {
                var confirm = MessageBox.Show("Are you sure you want to delete the question?", "Delete Confirmation", MessageBoxButtons.YesNo);
                if (confirm == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        MessageBox.Show("The question was deleted successfully.");
            ...
            else if (dataGridView1.Columns[e.ColumnIndex].Name == "editButton")
            {
                ...
                switch (selectedQuestion.Type)
                {
                    ...
                    default:
                        MessageBox.Show("Question type not supported for editing.");
                        break;
                }
